...
export default function PrePledgesError({
  error,
  reset,
}: {
  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-4 py-8 sm:px-6 sm:py-12 lg:px-10">
      <StatePanel
        variant="error"
        eyebrow="Pre-pledges unavailable"
        title="We couldn't load your intentions"
        description={`No backing action was taken. Try loading this screen again.${reference}`}
        action={
          <button
            type="button"
            onClick={() => reset()}
